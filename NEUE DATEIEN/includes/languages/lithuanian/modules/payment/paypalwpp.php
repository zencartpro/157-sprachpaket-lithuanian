...
* @version $Id: paypalwpp.php 2022-01-14 17:29:16Z webchills $
*/
...
define('MODULES_PAYMENT_PAYPALWPP_MESSAGE_STACK_CHECKOUT_SHIPPING', 'You pay with PayPal and use a PayPal deposited delivery address.<br>We want to make sure that this delivery address is correct, so we have redirected you to this page.<br>Please check the delivery address and change it if necessary.<br>Address correct? Fine!<br>Click on Continue in the lower right corner and confirm again with the Buy button in the last step.<br>PayPal payment and order are only carried out if you confirm the order in this way.');