 ...
 * @version $Id: button_names.php 2024-08-15 10:46:24Z webchills $
 */
...
define('BUTTON_CREATE_ACCOUNT_ALT', 'Prisijungti');
define('BUTTON_LOG_OFF_ALT', 'Atsijungti');

define('BUTTON_ADD_ADDRESS_ALT', 'Įrašyti adresą');
define('BUTTON_ADD_PRODUCTS_TO_CART_ALT','Įtraukti pažymėtas prekes į krepšelį');
define('BUTTON_BACK_ALT', 'Grįžti');
define('BUTTON_BUY_NOW_ALT', 'Pirkti dabar');
define('BUTTON_CANCEL_ALT', 'Atšaukti');
define('BUTTON_CHANGE_ADDRESS_ALT', 'Keisti adresą');
define('BUTTON_CHECKOUT_ALT', 'Gauti sąskaitą');
define('BUTTON_CONFIRM_SEND_ALT', 'Siųsti Dovanų Kuponą');
define('BUTTON_CONFIRM_ORDER_ALT', 'Patvirtinti užsakymą');
define('BUTTON_CONTACT_US_TEXT', 'Contact Us');
define('BUTTON_CONTINUE_ALT', 'Tęsti');
define('BUTTON_CONTINUE_SHOPPING_ALT', 'Tęsti apsipirkimą');
define('BUTTON_DELETE_ALT', 'Trinti');
define('BUTTON_DELETE_SMALL_ALT', 'Trinti');
define('BUTTON_DOWNLOAD_ALT', 'Parsisiųsti dabar');
define('BUTTON_DROPSHIPPING_ALT', 'Special Order');
define('BUTTON_DROPSHIPPING_SMALL_ALT', 'Special Order');
define('BUTTON_EDIT_SMALL_ALT', 'Keisti');
define('BUTTON_IN_CART_ALT', 'Įtraukti į krepšelį');
define('BUTTON_LOGIN_ALT', 'Prisijungti');
define('BUTTON_LOOKUP_ALT', 'Ieškoti');
define('BUTTON_MY_ORDERS_TEXT', 'Mano užsakymai');
define('BUTTON_NEXT_ALT', 'Sekantis');
define('BUTTON_PREVIOUS_ALT', 'Ankstesnis');
define('BUTTON_REDEEM_ALT', 'Patvirtinti');
define('BUTTON_RETURN_TO_PROD_LIST_ALT', 'Grįžti į prekių sąrašą');
define('BUTTON_REVIEWS_ALT', 'Eiti į apžvalgų puslapį');
define('BUTTON_SEARCH_ALT', 'Paieška');
define('BUTTON_SEND_ALT', 'Siųsti dabar');
define('BUTTON_SEND_ANOTHER_ALT', 'Siųsti kitą Dovanų Kuponą');
define('BUTTON_SEND_A_GIFT_CERT_ALT', 'Siųsti Dovanų Kuponą');
define('BUTTON_SHIPPING_ESTIMATOR_ALT', 'Pristatymo apskaičiavimas');
define('BUTTON_SOLD_OUT_ALT', 'Parduota');
define('BUTTON_SOLD_OUT_SMALL_ALT', 'Parduota');
define('BUTTON_SUBMIT_ALT', 'Išsaugoti informaciją');
define('BUTTON_SUBMIT_GO_ALT','Go');

define('BUTTON_UNSUBSCRIBE', 'Atsisakyti');
define('BUTTON_UPDATE_ALT', 'Atnaujinti');
define('BUTTON_VIEW_SMALL_ALT', 'Peržiūrėti');
define('BUTTON_WRITE_REVIEW_ALT', 'Rašyti apžvalgą');
define('BUTTON_READ_REVIEWS_ALT', 'Skaityti apžvalgą');
define('BUTTON_GOTO_PROD_DETAILS_ALT', 'Peržiūrėti šios prekės smulkesnę informaciją');
define('BUTTON_MORE_REVIEWS_ALT', 'Skaityti daugiau apžvalgų');
define('BUTTON_VIEW_ALL_ALT', 'Peržiūrėti viską');
define('BUTTON_ASK_A_QUESTION_ALT', 'Užduoti klausimą');
