 ...
 * @version $Id: orders.php 2024-08-15 11:49:16Z webchills $
 */
...
define('EMAIL_TEXT_SUBJECT', 'Atnaujinta užsakymo būsena');
define('EMAIL_TEXT_ORDER_CUSTOMER_GENDER_MALE', 'Gerbiamasis ponas ');
define('EMAIL_TEXT_ORDER_CUSTOMER_GENDER_FEMALE', 'Gerbiama ponia ');
define('EMAIL_TEXT_ORDER_CUSTOMER_NEUTRAL', 'Sveiki ');
define('EMAIL_TEXT_UPDATEINFO', 'Apie užsakymo būseną jus informuosime adresu ');
define('EMAIL_TEXT_ORDER_NUMBER', 'Užsakymo numeris:');
define('EMAIL_TEXT_INVOICE_URL', 'Išsami sąskaita faktūra:');
define('EMAIL_TEXT_DATE_ORDERED', 'Užsakymo data:');
define('EMAIL_TEXT_COMMENTS_UPDATE', '<strong>Pastaba:</strong> ' . "\n\n");
define('EMAIL_TEXT_STATUS_UPDATED', 'Jūsų užsakymo būsena atnaujinta.' . "\n\n");
define('EMAIL_TEXT_STATUS_LABEL', '<strong>Naujas statusas:</strong> %s' . "\n\n");
define('EMAIL_TEXT_STATUS_PLEASE_REPLY', 'Jei turite klausimų, kreipkitės šiuo el. pašto adresu <a href="mailto:' . STORE_OWNER_EMAIL_ADDRESS . '">' . STORE_OWNER_EMAIL_ADDRESS . '</a>.<br>' . "\n");
