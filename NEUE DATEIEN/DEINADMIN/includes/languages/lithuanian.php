 ...
 * @version $Id: lithuanian.php 2024-08-19 12:40:04Z webchills $
 */
...
define('BOX_CATALOG_CATEGORIES_OPTIONS_VALUES_MANAGER','Optionswerte Manager');
...
define('BOX_CATALOG_PRODUCT_OPTIONS_VALUES','Optionswerte Sortierung');
...
define('BOX_TOOLS_EMAIL_EXPORT', 'E-Mailadressen Export');
...
define('ENTRY_EMAIL_ADDRESS_CHECK_ERROR','&nbsp;<span class="errorText">Die E-Mailadresse scheint ungültig zu sein!</span>');
define('ENTRY_EMAIL_ADDRESS_ERROR','&nbsp;<span class="errorText">mindestens ' . ENTRY_EMAIL_ADDRESS_MIN_LENGTH . ' Zeichen</span>');
define('ENTRY_EMAIL_ADDRESS_ERROR_EXISTS','&nbsp;<span class="errorText">Diese E-Mailadresse existiert bereits!</span>');
...
define('TEXT_ATTRIBUTES_INSERT_INFO','<strong>Definieren Sie die Attribut Einstellungen und klicken Sie dann auf Einfügen, um sie anzuwenden</strong>');
...
define('TEXT_WARNING_HTML_DISABLED','<span class = "main">HINWEIS: Sie verwenden TEXT only E-Mails. Falls Sie HTML E-Mails verschicken wollen, aktivieren Sie das unter Konfiguration > E-Mail Optionen</span>');
...
define('WARNING_EMAIL_SYSTEM_DEVELOPER_EMAIL','WARNUNG: ALLE E-Mails werden gesendet an %1$s (wie definiert in "DEVELOPER_OVERRIDE_EMAIL_ADDRESS") mit EMAIL_TRANSPORT=%2$s.');
...
define('WARNING_EMAIL_SYSTEM_DISABLED','WARNUNG: Das E-Mailsystem ist abgeschaltet. Es werden keine E-Mails versendet, solange Sie das nicht unter Konfiguration > E-Mail Optionen aktivieren.');
...
define('WARNING_WELCOME_DISCOUNT_COUPON_EXPIRES_IN','WARNUNG! Der Willkommens E-Mail Rabatt Kupon läuft ab in %s Tagen');
